...
Pod::Spec.new do |s|
  ...
  s.version          = '0.1.0'
  s.summary          = 'A short description of EggCustomDialog.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/Peerapat.Pro/EggCustomDialog'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'Peerapat.Pro' => 'peerapat.pro@ascendcorp.com' }
  s.source           = { :git => 'https://github.com/Peerapat.Pro/EggCustomDialog.git', :tag => s.version.to_s }
